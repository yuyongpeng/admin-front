  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" stripe="true" highlight-current-row="true" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片" align="center" prop="resource_url">
        <template #default="scope">
          <el-image style="width: 100px; height: 100px" :src="scope.row.resource_url" :zoom-rate="1.2" :max-scale="7" :min-scale="0.2" :preview-src-list="[scope.row.resource_url]" show-progress :initial-index="1" fit="cover" preview-teleported="true"/>
    ...
    <el-dialog :title="title" v-model="open" width="700px" append-to-body>
      <el-form ref="postRef" :model="form" :rules="rules" label-width="200px">
        ...
        <el-form-item label="邮折" prop="ticket_id">
          <el-select v-model="form.ticket_id" placeholder="选择邮折" >
            <el-option v-for="item in tickets" :key="item.id" :label="item.ticket_name" :value="item.id" />
          </el-select>
          <!-- <el-input v-model="form.ticket_id" placeholder="门票ID"/> -->
        </el-form-item>
        <el-form-item label="图片URL" prop="resource_url">
          <ImageUpload limit="1" fileSize="5" :fileType="imageType" isShowTip="true" isFormat="true" v-model="form.resource_url"  ></ImageUpload>
        </el-form-item>
